...
/**
 * Close icon (X) - Material Design style
 * Used in dialogs, modals, and dismissible elements
 */
...
/**
 * Sync/Refresh icon
 * Used for synchronization and refresh actions
 */
...
/**
 * External Link icon
 * Used for links that open in a new window/tab
 */
