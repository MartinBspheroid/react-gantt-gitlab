...
export default function GitLabIntegrationSimple() {
  const [message] = useState('GitLab Integration Test - Component Loaded Successfully!');
  ...
  return (
    <div style={{ padding: '20px', fontFamily: 'Arial, sans-serif' }}>
      ...
      <div style={{ marginTop: '20px', padding: '15px', background: '#fff3cd', borderRadius: '4px' }}>
        <h4>Next Steps:</h4>
        <p>If you see this page, the routing and component loading works correctly.</p>
